...
class Pie(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        x += self.h
        y -= tick-x*0.002
        self.h -=(tick/2000)-(x-y)
        self.rect.x = int(x/(10**100))/999999999999999999+500
        self.rect.y = int(y/(10**100))/999999999999999999+500
        self.x = x
        self.y = y
def reset():
    lifes = 5
...
while do:
    ...
    if tick == 256:
        tick = 0
        idk.add(Pie(r.randint(0,screenw),r.randint(0,screenh)))
    screen.fill((0,tick,0))
